lib.loc = "~/rmd_packages/"



require(dplyr, lib.loc = lib.loc)
require(ggplot2, lib.loc = lib.loc)
require(readr, lib.loc = lib.loc)
require(RColorBrewer, lib.loc = lib.loc)
require(scales, lib.loc = lib.loc)
require(tibble, lib.loc = lib.loc)
require(tidyr, lib.loc = lib.loc)
require(rprintf, lib.loc = lib.loc)
require(readxl, lib.loc = lib.loc)
require(knitr, lib.loc = lib.loc)
require(testthat, lib.loc = lib.loc)
require(ssanv, lib.loc = lib.loc) # for uniroot.integer
